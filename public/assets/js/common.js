...
function skinChanger() {
	$('.choose-skin li').on('click', function() {
	    ...
	    var darkLogo = "../assets/images/logo-icon-dark.svg";
	    var lightLogo = "../assets/images/logo-icon-light.svg";
...
function CustomJs() {
	...
	$(window).on('load resize', function() {
		if($(window).innerWidth() < 420) {
			$('.navbar-brand logo.svg').attr('src', '../assets/images/logo-icon-light.svg');
		} else {
			$('.navbar-brand logo-icon-light.svg').attr('src', '../assets/images/logo.svg');
		}
	});
